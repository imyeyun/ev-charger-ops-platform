...
// (선택) 코드 -> 이름 매핑도 같이 export (필터링/표시용)
export const SIDO_NAME_BY_CODE = Object.fromEntries(SIDO_OPTIONS.map((x) => [x.code, x.name]));
export const SIGUN_NAME_BY_CODE = Object.fromEntries(SIGUN_OPTIONS.map((x) => [x.code, x.name]));
